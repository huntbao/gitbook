 ...
 */
function processOutput(generator, startOutput, filePath) {
    ...
    .then(function (output) {
        return generateAssets(generator, output, filePath);
    })
    .then(function (output) {
        return generatePages(generator, output, filePath);
    })
...
function generateBook(generator, book, options) {
    ...
    .then(function (output) {
        return processOutput(generator, output, filePath);
    })
